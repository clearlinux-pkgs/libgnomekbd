...
Version  : 3.22.0.1
Release  : 1
URL      : https://github.com/GNOME/libgnomekbd/archive/3.22.0.1.tar.gz
Source0  : https://github.com/GNOME/libgnomekbd/archive/3.22.0.1.tar.gz
...
%prep
%setup -q -n libgnomekbd-3.22.0.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1500498044
